...
CHAT_SYSTEM = (
  ...
  "Use valid compact JSON with double-quoted keys and values."
  "If the prefix, original, and suffix uniquely determine your edit, you do not need exact start/end character positions, but they need to be in the right ballpark."
